...
class GraphFactoryTraining(GraphFactoryBase):
            ...
            for _ in range(self._num_pairs_in_epoch):
                ...
                for pair in pairs:
                    ...
                    for func in pair:
                        ...
                        idb, fva = func
                        cfg = nx.DiGraph(str_to_scipy_sparse(self._fdict[idb][fva]['cfg']))
                        ddg = nx.DiGraph(str_to_scipy_sparse(self._fdict[idb][fva]['ddg']))
                        g = nx.MultiDiGraph()
                        ...
                        #     nx.DiGraph(
                        #         str_to_scipy_sparse(
                        #             self._fdict[idb][fva]['cfg'])))\
                        g_list.append(g)

                        if self._use_features:
                            if self._features_type == 'roberta':
                                stranddict = self._fdict[idb][fva]['strandinfo']
                                strands = []
                                ...
                                embed = self._decoder_feat(self._fdict[idb][fva][self._features_type])
    ...
    def pairs(self):
        ...
        for _ in tqdm(range(self._num_batches_in_epoch),
            ...
            # batch_graphs contains pos and neg pairs respectively
