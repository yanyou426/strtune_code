...
class GNNModel:
    ...
    def _create_network(self, batch_generator):
        ...
        node_feature = first_batch_graphs.node_features[0]
        edge_feature = first_batch_graphs.edge_features[0]
        log.info("node_feature_dim: %d", node_feature_dim)
        log.info("edge_feature_dim: %d", edge_feature_dim)
        log.info("node_feature_shape: {}".format(node_feature))
        log.info("edge_feature_shape: {}".format(edge_feature))
    ...
    def model_test(self):
        ...
        self._create_tfsaver()
        self._restore_model()
        # print('*******************eval_metrics is: {}'.format(self._tensors['metrics']['evaluation']))
